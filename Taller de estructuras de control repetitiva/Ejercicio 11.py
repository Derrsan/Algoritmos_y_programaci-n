...
while True:
    ...
    depositar = input("Quieres depositar el dinero: ").capitalize()
    ...
    if depositar == 'Si':
        ...
        while True:
            retiro = input("Quiere retirar su dinero?: ").capitalize()
        ...
        consultar_saldo = input("Desea saber cual es su saldo: ").capitalize()
