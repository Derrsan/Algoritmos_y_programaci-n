...
while True:
    ...
    if ContinuarEncuesta == "si":
        ...
        break  
print(f"Total de personas que consumen licor son: {ContadorLicor}")
print(f"Total de mujeres menor de edad son: {ContadorEdadMujer}")
print(f"Total de hombres que no consumenten aguardiente y tienen entre 20 y 25 años son: {ContadorHombres}" )
print(f"Promedio de edad de quines consumen cerveza son:{EdadPromedio/ContadorCerveza}")
print(f"Personas que consumen whisky respeto al total encuentado es: {(ContadorWhisky/ContadorLicor)*100}")